	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="${pageContext.request.contextPath}/index.jsp">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath}/findProductByCid?cid=${product.category.cid}">${product.category.cname}&nbsp;&nbsp;&gt;</a>
				<a href="${pageContext.request.contextPath}/findProductByPid?pid=${product.pid}">${product.pname}</a>
			</div>
			...
			<div style="width: 950px; margin: 0 auto;">
				...
				<div>
					<p style="text-align: left">商品详情：${product.pdesc}</p>
					<img src="${product.pimage}">
					<p style="text-align: left">上市时间：${product.pdate}</p>
				</div>
